...
async function signup() {
    ...
    if (password !== password2) {
        errorTitleElement.textContent = "Validation Error";
        errorMessageElement.textContent = "Please make sure passwords match.";
        errorPopup.style.display = 'flex';
        overlay.style.display = 'flex';
        return;
    }
    ...
    try {
        ...
        if (response.ok) {
            ...
            successMessageElement.textContent = data.message || "Registration successful!";
            ...
            errorTitleElement.textContent = "Registration Failed";
